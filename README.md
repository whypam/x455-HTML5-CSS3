...
# X455 - Web Design With HTML5 and CSS3 DESIGN
...
1. Code 6 webpages in HTML and CSS, and make use of JavaScript and JQuery to enhance the webpages functionality (JavaScript and JQuery codes will be provided).
2. Commit project code base to GitHub repository.
3. Host project website on GitHub.
4. Complete written summary of final project.
5. Present and peer review final project.
...
2. Install Visual Studio Code (coding editor) on your computer.
